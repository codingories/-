<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="Session" label="年级" />
      <el-table-column prop="schoolyear" label="届次名次" />
      <el-table-column prop="graduationyear" label="名称" />
      <el-table-column prop="ifGraduation" label="班主任" />
      <el-table-column prop="remark" label="老师" />
      <el-table-column prop="status" label="是否毕业年" />
